...
FORCEINLINE void VectorStoreAligned(VectorRegister4Double Vec, float* Dst)
{
...
#if SUPPORT_DOUBLE_TO_FLOAT_VECTOR_CONVERSION
FORCEINLINE void VectorStore(VectorRegister4Double Vec, float* Dst)
{
...
#if SUPPORT_DOUBLE_TO_FLOAT_VECTOR_CONVERSION
FORCEINLINE void VectorStoreFloat3(VectorRegister4Double Vec, float* Dst)
{
	VectorRegister4Float FloatVec = MakeVectorRegisterFloatFromDouble(Vec);
...
#if SUPPORT_DOUBLE_TO_FLOAT_VECTOR_CONVERSION
FORCEINLINE void VectorStoreFloat1(VectorRegister4Double Vec, float* Dst)
{
	VectorRegister4Float FloatVec = MakeVectorRegisterFloatFromDouble(Vec);
