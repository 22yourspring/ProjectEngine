...
#include "UE/Math/VectorRegister.h"
...
public:
	...
	/** default constructor */
	[[nodiscard]] UE_FORCEINLINE_HINT ScalarRegister();

	/** Copy Constructor */
	[[nodiscard]] UE_FORCEINLINE_HINT ScalarRegister(const ScalarRegister& VectorValue);

	/** Constructor using float value */
	[[nodiscard]] explicit UE_FORCEINLINE_HINT ScalarRegister(const float& ScalarValue);

	/** Constructor
	 *
	 * @param RegisterType float4 vector register type
	 */
	[[nodiscard]] explicit UE_FORCEINLINE_HINT ScalarRegister(RegisterType VectorValue);
	 ...
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT ScalarRegister operator*(const ScalarRegister& RHS) const;
	 ...
	 */
	inline ScalarRegister& operator+=(const ScalarRegister& RHS);
	 ...
	 */
	inline ScalarRegister& operator=(const RegisterType& RHS);

	/**
	 * ScalarRegister to RegisterType conversion operator.
	 */
	UE_FORCEINLINE_HINT operator RegisterType() const;
};

UE_FORCEINLINE_HINT ScalarRegister::ScalarRegister()
{
}

UE_FORCEINLINE_HINT ScalarRegister::ScalarRegister(const ScalarRegister& VectorValue)
{
	Value = VectorValue.Value;
}

UE_FORCEINLINE_HINT ScalarRegister::ScalarRegister(const float& ScalarValue)
{
	Value = VectorLoadFloat1(&ScalarValue);
}

UE_FORCEINLINE_HINT ScalarRegister::ScalarRegister(RegisterType VectorValue)
{
	Value = VectorValue;
}

UE_FORCEINLINE_HINT ScalarRegister ScalarRegister::operator*(const ScalarRegister& RHS) const
{
...
inline ScalarRegister& ScalarRegister::operator+=(const ScalarRegister& RHS)
{
...
inline ScalarRegister& ScalarRegister::operator=(const RegisterType& RHS)
{
	Value = RHS;
	return *this;
}

UE_FORCEINLINE_HINT ScalarRegister::operator RegisterType() const
{
	return Value;
}
...
UE_FORCEINLINE_HINT ScalarRegister ScalarMin(const ScalarRegister& A, const ScalarRegister& B)
{
	return ScalarRegister(VectorMin(A.Value, B.Value));
}

/** Returns the larger of the two values */
UE_FORCEINLINE_HINT ScalarRegister ScalarMax(const ScalarRegister& A, const ScalarRegister& B)
{
...
template<> struct TCustomLerp<ScalarRegister>
{
	...
	inline ScalarRegister Lerp(const ScalarRegister& A, const ScalarRegister& B, const ScalarRegister& Alpha)
	{
 ...
 */
UE_FORCEINLINE_HINT ScalarRegister ScalarReciprocal(const ScalarRegister& A)
{
