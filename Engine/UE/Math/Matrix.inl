 ...
 */
 ...
 // Constructors.
template<typename T>
inline  TMatrix<T>::TMatrix(const TPlane<T>& InX, const TPlane<T>& InY, const TPlane<T>& InZ, const TPlane<T>& InW)
{
...
template<typename T>
inline void TMatrix<T>::operator*=(const TMatrix<T>& Other)
{
...
template<typename T>
inline void TMatrix<T>::operator*=(T Other)
{
	*this = *this * Other;
	DiagnosticCheckNaN();
}
...
template<typename T>
inline TVector4<T> TMatrix<T>::TransformFVector4(const TVector4<T>& P) const
{
	TVector4<T> Result;
...
template<typename T>
UE_FORCEINLINE_HINT TVector4<T> TMatrix<T>::TransformPosition(const TVector<T>& V) const
{
...
template<typename T>
inline TVector<T> TMatrix<T>::InverseTransformPosition(const TVector<T>& V) const
{
 ...
 */
template<typename T>
UE_FORCEINLINE_HINT TVector4<T> TMatrix<T>::TransformVector(const TVector<T>& V) const
{
...
template<typename T>
inline TVector<T> TMatrix<T>::InverseTransformVector(const TVector<T>& V) const
{
	TMatrix<T> InvSelf = this->InverseFast();
...
template<typename T>
inline TMatrix<T> TMatrix<T>::GetTransposed() const
{
	TMatrix<T>	Result;
...
*/
template<typename T>
inline void TMatrix<T>::To3x4MatrixTranspose(T* Out) const
{
...
template<>
inline void TMatrix<float>::To3x4MatrixTranspose(float* Out) const
{
...
template<typename T>
inline TMatrix<T> TMatrix<T>::ConcatTranslation(const TVector<T>& Translation) const
{
	TMatrix<T> Result;
...
template <typename T>
inline bool MakeFrustumPlane(T A, T B, T C, T D, TPlane<T>& OutPlane)
{
...
template<typename T>
inline bool TMatrix<T>::GetFrustumNearPlane(TPlane<T>& OutPlane) const
{
...
template<typename T>
inline bool TMatrix<T>::GetFrustumFarPlane(TPlane<T>& OutPlane) const
{
	return MakeFrustumPlane(
		M[0][2],
		M[1][2],
...
template<typename T>
inline bool TMatrix<T>::GetFrustumLeftPlane(TPlane<T>& OutPlane) const
{
	return MakeFrustumPlane(
		M[0][3] + M[0][0],
		M[1][3] + M[1][0],
...
template<typename T>
inline bool TMatrix<T>::GetFrustumRightPlane(TPlane<T>& OutPlane) const
{
	return MakeFrustumPlane(
		M[0][3] - M[0][0],
		M[1][3] - M[1][0],
...
template<typename T>
inline bool TMatrix<T>::GetFrustumTopPlane(TPlane<T>& OutPlane) const
{
	return MakeFrustumPlane(
		M[0][3] - M[0][1],
		M[1][3] - M[1][1],
...
template<typename T>
inline bool TMatrix<T>::GetFrustumBottomPlane(TPlane<T>& OutPlane) const
{
	return MakeFrustumPlane(
		M[0][3] + M[0][1],
		M[1][3] + M[1][1],
...
template<typename T>
inline TBasisVectorMatrix<T>::TBasisVectorMatrix(const TVector<T>& XAxis,const TVector<T>& YAxis,const TVector<T>& ZAxis,const TVector<T>& Origin)
{
...
template<typename T>
inline TLookFromMatrix<T>::TLookFromMatrix(const TVector<T>& EyePosition, const TVector<T>& LookDirection, const TVector<T>& UpVector)
{
...
template<typename T>
UE_FORCEINLINE_HINT TLookAtMatrix<T>::TLookAtMatrix(const TVector<T>& EyePosition, const TVector<T>& LookAtPosition, const TVector<T>& UpVector) :
