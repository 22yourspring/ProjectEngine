...
public:
	...
	[[nodiscard]] std::string ToString() const
	{
		...
		Output += StringFormat("[%g %g %g %g] ", M[2][0], M[2][1], M[2][2], M[2][3]);
		Output += StringFormat("[%g %g %g %g] ", M[3][0], M[3][1], M[3][2], M[3][3]);
...
#include "UE/Math/Matrix.inl" // IWYU pragma: export
